<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend/Site1.Master" AutoEventWireup="true" CodeBehind="jieshus.aspx.cs" Inherits="Code10.Frontend.WebForm6" %>
 ...
 <div class="jieshu_1">
  ...
  <div class="dan_1_2">
    <form id="form2" name="form2" method="post" action="">
      ...
      <input type="text" style=" width:208px; height:32px; background:url(../webform项目/images1/tu5.png) no-repeat; border:none;"/>
    </form>
  </div>
  ...
  <div class="dan_1_4">请填写真实联系方式。</div>
   ...
   <div class="dan_2_2">
   <div class="dan_2_2a">
   <div class="dan_2_2_1"><img src="../webform项目/images1/shu1.jpg" /></div></div>
  ...
  <br />
 <div class="dan_5">
 <div class="dan_5_1"><a href="jieshus.aspx"><img src="../webform项目/images1/tijiao.jpg" /></a></div>
 </div>
  </div>
   ...
   <h3 class="h3_1">请将支付的结果发图给我们，</h3><a href="#">&nbsp;&nbsp;QQ: 12456610174</a>
    ...
    <div class="ye_2"><a href="jieshus.aspx"><img src="../webform项目/images1/tu15.jpg" /></a></div>
   </div>
   </div>
 </div>
</div>
