<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Code10.backstage.about.About" %>
<%@ Import Namespace="Code10.backstage.about" %>
            ...
            <div>
                <div class=" container">
                    <div class="jumbotron">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control bg-none">
                                            <select id="provice" class="select">
                                                <option><%=About.Dizhi[0]%></option>
                                            </select>
                                            <select id="city" class="select">
                                                <option><%=About.Dizhi[1]%></option>
                                            </select>
                                            <select id="area" class="select">
                                                <option><%=About.Dizhi[2]%></option>
                                            </select>
                        ...
                        <a class="lower-right" href="../share/Index.aspx" runat="server" role="button">返回</a>
                    </div>
                </div>
                <script>
