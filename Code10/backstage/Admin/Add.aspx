<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/AddSite.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Code10.backstage.Admin.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p class="col-sm-12">&nbsp;</p>
    <label for="root" class="col-sm-3 col-form-label h4">root:</label>
    <div class="col-sm-9">
    ...
    <p class="col-sm-12">&nbsp;</p>
    <label for="pwd" class="col-sm-3 col-form-label h4">pwd:</label>
    <div class="col-sm-9">
