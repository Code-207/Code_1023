<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/BackStage.Master" AutoEventWireup="true" CodeBehind="jieshu.aspx.cs" Inherits="Code10.backstage.jieshu.jieshu" %>
            ...
            <div class="float-left">
                ...
                <ul class="pagination">
                    ...
                    <%
                        ...
                        {
                            Response.Write("<li class='page-item'><a class='page-link' href='User.aspx?id="+(i+1)+"'>"+(i+1)+"</a></li>");
                        } %>
                    ...
                    <tbody>
                        <asp:Repeater ID="rep" runat="server">
                            <ItemTemplate>                                <tr>
                                    ...
                                    <td><%#Eval("jieshu_name") %></td>
                                    <td><%#Eval("jieshu_price")%>￥</td>
                                    <td>
