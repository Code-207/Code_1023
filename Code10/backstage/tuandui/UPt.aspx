<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UPt.aspx.cs" Inherits="Code10.backstage.tuandui.UPt" %>
            ...
            <div class="jumbotron">
                ...
                <div class="main row">
                    ...
                    <div class="col-9">
                        ...
                        <br />
                        <label class="col-form-label">intof：</label>
                        <div class="form-group">
                            <textarea rows="9" cols="90" runat="server" id="intof"></textarea>
                        </div>
