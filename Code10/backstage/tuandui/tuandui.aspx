<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/BackStage.Master" AutoEventWireup="true" CodeBehind="tuandui.aspx.cs" Inherits="Code10.backstage.tuandui.tuandui" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Repeater ID="rep" runat="server">
            <ItemTemplate>
                <div class="bor row">
                <div class="col-3">
                    <img class="I-L" src="../img/tuandui/<%#Eval("iamgeurl")%>"/>
                </div>
                <div class="col-9">
                    <h2><%#Eval("name")%></h2>
                    <small><%#Eval("intof")%>
    ...
    <nav aria-label="Page navigation example" class="pull-right">
        <ul class="pagination">
            ...
            <%
                ...
                {
                    Response.Write("<li class='page-item'><a class='page-link' href='tuandui.aspx?id=" + (i + 1) + "'>" + (i + 1) + "</a></li>");
                } %>
