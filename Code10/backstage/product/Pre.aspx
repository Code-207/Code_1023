<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/BackStage.Master" AutoEventWireup="true" CodeBehind="Pre.aspx.cs" Inherits="Code10.backstage.product.Pre" %>
                        ...
                        <asp:Repeater  ID="rep" runat="server">
                            <ItemTemplate>                                
                                <tr>
                                    ...
                                    <td class="root"><%#Eval("product_intro")%></td>
                                <td class="root"><%#Eval("product_price")%></td>
                                    <td class="root"><%#Eval("product_content")%></td>
                                    <td>
