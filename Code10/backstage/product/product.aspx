<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/BackStage.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="Code10.backstage.product.product" %>
                        ...
                        <asp:Repeater  ID="rep" runat="server">
                            <ItemTemplate>                                
                                <tr>
                                    ...
                                    <td ><%#Eval("product_intro")%></td>
                                <td ><%#Eval("product_price")%></td>
                                    <td ><%#Eval("product_content").ToString().Substring(1,10)%></td>
                                    <td>
                                        <a href="../share/del.aspx?id=<%#Eval("ID") %>">del/</a>
                                        <a href="upt.html">upt</a>
                                        <a href="AddPre.aspx.html?id=<%#Eval("ID") %>">upt</a>
                                        </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
