<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="upt.aspx.cs" Inherits="Code10.backstage.product.upt" %>
                    ...
                    <div class="col-9">
                        <br />
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="product_name"></asp:TextBox>
                            </div>
                        <br />
                        <div class="form-group">
                            <label class="col-form-label">product_intro</label>
                            <asp:TextBox runat="server" ID="product_intro"></asp:TextBox>
                        </div>
                        <br />
                        <div class="form-group">
                            <label class="col-form-label">product_price：</label>
                            <asp:TextBox runat="server" ID="product_price"></asp:TextBox>
                        </div>
                        
                        <label class="col-form-label">product_content：</label>
                        <div class="form-group">
                            <textarea runat="server" id="product_content"></textarea>
                        </div>
