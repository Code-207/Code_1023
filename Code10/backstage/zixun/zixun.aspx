<%@ Page Title="" Language="C#" MasterPageFile="~/backstage/BackStage.Master" AutoEventWireup="true" CodeBehind="zixun.aspx.cs" Inherits="Code10.backstage.zixun.zixun" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h1 class="center-title h-auto">Admin</h1>
        <asp:Repeater ID="rep" runat="server">
            <ItemTemplate>
                <div class="bor row">
                <div class="col-3">
                    <img class="I-L" src="../img/zixun/<%#Eval("imgurl")%>"/>
                </div>
                <div class="col-9 text text-body overflow: hidden" >
                    <h2><%#Eval("name")%>/<%#Eval("title")%></h2>
                    <div style="max-height: 90px; height: 70px;">
                        <small style="max-height: 130px"><%#Eval("content")%>
                        </small>
                    </div>
                    <br />
    ...
    <nav aria-label="Page navigation example" class="pull-right">
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link active" href="Add.aspx">添加</a></li>
